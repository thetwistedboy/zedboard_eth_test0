...
module design_1
  ...
  (* X_INTERFACE_INFO = "digilentinc.com:interface:pmod:1.0 Pmod_out_0 PIN10_I" *) (* X_INTERFACE_MODE = "Master" *) input Pmod_out_0_pin10_i;
  ...
  design_1_PmodESP32_0_0 PmodESP32_0
       (.AXI_LITE_GPIO_araddr(axi_smc_M00_AXI_ARADDR),
        .AXI_LITE_GPIO_arready(axi_smc_M00_AXI_ARREADY),
        .AXI_LITE_GPIO_arvalid(axi_smc_M00_AXI_ARVALID),
        .AXI_LITE_GPIO_awaddr(axi_smc_M00_AXI_AWADDR),
        ...
        .AXI_LITE_UART_araddr(axi_smc_M01_AXI_ARADDR),
        .AXI_LITE_UART_arready(axi_smc_M01_AXI_ARREADY),
        .AXI_LITE_UART_arvalid(axi_smc_M01_AXI_ARVALID),
        .AXI_LITE_UART_awaddr(axi_smc_M01_AXI_AWADDR),
        .AXI_LITE_UART_awready(axi_smc_M01_AXI_AWREADY),
        .AXI_LITE_UART_awvalid(axi_smc_M01_AXI_AWVALID),
        .AXI_LITE_UART_bready(axi_smc_M01_AXI_BREADY),
        .AXI_LITE_UART_bresp(axi_smc_M01_AXI_BRESP),
        .AXI_LITE_UART_bvalid(axi_smc_M01_AXI_BVALID),
        .AXI_LITE_UART_rdata(axi_smc_M01_AXI_RDATA),
        .AXI_LITE_UART_rready(axi_smc_M01_AXI_RREADY),
        .AXI_LITE_UART_rresp(axi_smc_M01_AXI_RRESP),
        .AXI_LITE_UART_rvalid(axi_smc_M01_AXI_RVALID),
        .AXI_LITE_UART_wdata(axi_smc_M01_AXI_WDATA),
        .AXI_LITE_UART_wready(axi_smc_M01_AXI_WREADY),
        .AXI_LITE_UART_wstrb(axi_smc_M01_AXI_WSTRB),
        .AXI_LITE_UART_wvalid(axi_smc_M01_AXI_WVALID),
        .Pmod_out_pin10_i(Pmod_out_0_pin10_i),
        .Pmod_out_pin10_o(Pmod_out_0_pin10_o),
        .Pmod_out_pin10_t(Pmod_out_0_pin10_t),
        .Pmod_out_pin1_i(Pmod_out_0_pin1_i),
        .Pmod_out_pin1_o(Pmod_out_0_pin1_o),
        .Pmod_out_pin1_t(Pmod_out_0_pin1_t),
        .Pmod_out_pin2_i(Pmod_out_0_pin2_i),
        .Pmod_out_pin2_o(Pmod_out_0_pin2_o),
        .Pmod_out_pin2_t(Pmod_out_0_pin2_t),
        .Pmod_out_pin3_i(Pmod_out_0_pin3_i),
        .Pmod_out_pin3_o(Pmod_out_0_pin3_o),
        .Pmod_out_pin3_t(Pmod_out_0_pin3_t),
        .Pmod_out_pin4_i(Pmod_out_0_pin4_i),
        .Pmod_out_pin4_o(Pmod_out_0_pin4_o),
        .Pmod_out_pin4_t(Pmod_out_0_pin4_t),
        .Pmod_out_pin7_i(Pmod_out_0_pin7_i),
        .Pmod_out_pin7_o(Pmod_out_0_pin7_o),
        .Pmod_out_pin7_t(Pmod_out_0_pin7_t),
        .Pmod_out_pin8_i(Pmod_out_0_pin8_i),
        .Pmod_out_pin8_o(Pmod_out_0_pin8_o),
        .Pmod_out_pin8_t(Pmod_out_0_pin8_t),
        .Pmod_out_pin9_i(Pmod_out_0_pin9_i),
        .Pmod_out_pin9_o(Pmod_out_0_pin9_o),
        .Pmod_out_pin9_t(Pmod_out_0_pin9_t),
